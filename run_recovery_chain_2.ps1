...
Add-Content -Path $logFile -Value "=== RECOVERY 2: Resume FERPlus 8cls VICH (power outage at epoch 18/200; best.pt was corrupted, resuming with fresh best-tracking) ==="
python -u main_encoder.py --c FERPlus_8_vich_kld_200e_lr3e5_sam_processed_27may_resume.yaml --resume "results/teacher_logs/FER2013/POSTERv2/2026-07-09-12-21-49/last.pt" 2>&1 | Tee-Object -FilePath $logFile -Append
...
Add-Content -Path $logFile -Value "=== Recovery chain 2 complete: FERPlus (resumed) -> RAF-DB ==="
